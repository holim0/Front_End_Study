!(function (t) {
    ...
    function (t, n, r) {
        ...
        if (r(7)) {
            var e = r(29),
                ...
                Gt = function (t, n, r) {
                    return !(Wt(t, (n = x(n, !0))) && S(r) && b(r, "value")) ||
                        b(r, "get") ||
                        b(r, "set") ||
                        r.configurable ||
        ...
        ((n = t.exports = function (t, n, r, l, h) {
            ...
            if (o(y)) {
                for (v = c(t.length); v > b; b++)
                    if (
                        (g = n ? x(u((p = t[b]))[0], p[1]) : x(t[b])) === a ||
                        g === s
                    )
                        return g;
            } else
                for (d = y.call(t); !(p = d.next()).done; )
                    if ((g = i(d, x, p.value, n)) === a || g === s) return g;
        }).BREAK = a),
            (n.RETURN = s);
    },
    function (t, n, r) {
    ...
    function (t, n, r) {
        ...
        t.exports = function (t, n, r, p, d, g, y) {
            ...
            if (
                (A &&
                    (m = s(A.call(new t()))) !== Object.prototype &&
                    m.next &&
                    (a(m, w, !0), e || "function" == typeof m[l] || u(m, l, v)),
                _ &&
                    M &&
                    "values" !== M.name &&
                    ((E = !0),
        ...
        (a || s) &&
            (f = function (t) {
                ...
                return (
                    ...
                    a &&
                        e &&
                        (f.lastIndex = f.global ? e.index + e[0].length : n),
                    s &&
                        e &&
                        e.length > 1 &&
    ...
    function (t, n, r) {
        ...
        if (u.ABV) {
            if (
                ...
                a(function () {
                    return (
                        new x(), new x(1.5), new x(NaN), "ArrayBuffer" != x.name
                    );
                })
            ) {
                for (
        ...
        B ||
            (c(
                (R = function () {
                    ...
                    return (
                        o && Y && $(V, t, { configurable: !0, set: n }), J(t)
                    );
                }).prototype,
                "toString",
                function () {
            ...
            return [
                ...
                function (t, n) {
                    ...
                    for (var x = []; ; ) {
                        ...
                        if ((x.push(b), !g)) break;
                        "" === String(b[0]) &&
                            (l.lastIndex = c(h, o(l.lastIndex), y));
                    }
                    ...
                    function (t, n) {
                        ...
                        for (var m = 0, S = 0, w = []; S < h.length; ) {
                            ...
                            if (
                                ...
                                if ((w.push(h.slice(m, S)), w.length === b))
                                    return w;
                                for (var O = 1; O <= E.length - 1; O++)
                                    if ((w.push(E[O]), w.length === b))
                                        return w;
                                S = m = _;
                            }
                        }
            ...
            l(S, {
                ...
                of: function () {
                    for (
                        ...
                        r[t] = arguments[t++];
                    return new ("function" == typeof this ? this : S)(function (
                        t
                    ) {
                        var n = !1;
                        return (
    ...
    function (t, n, r) {
        for (
            ...
            var g,
                ...
                b = u[y],
                m = b && b.prototype;
            if (m && (m[s] || c(m, s, h), m[l] || c(m, l, y), (f[y] = h), x))
        ...
        (function (n) {
            !(function (n) {
                ...
                if (a) f && (t.exports = a);
                    ...
                    (x.prototype = p.constructor = b),
                        (b.constructor = x),
                        (b[c] = x.displayName = "GeneratorFunction"),
